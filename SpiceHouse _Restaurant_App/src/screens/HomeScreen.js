...
//    console.log(vegData);
    ...
    return(
        ...
        <CardSlider title={"All available Items"} data={foodData} navigation={navigation} scroll={true}/>
        <CardSlider title={"NonVeg Love"} data={nonVegData} navigation={navigation} scroll={true}/>
        <CardSlider title={"Veg Hunger"} data={vegData} navigation={navigation} scroll={true}/>
